...
function initData(vueOptions, context) {
  ...
  if (typeof data === 'function') {
    try {
      ...
      if (Object({"NODE_ENV":"development","VUE_APP_DARK_MODE":"false","VUE_APP_NAME":"ei-calendar","VUE_APP_PLATFORM":"mp-weixin","BASE_URL":"/"}).VUE_APP_DEBUG) {
...
/* 26 */
/*!***************************************************!*\
  !*** D:/桌面/大三上所有课程作业/app开发作业/RiliQimo/pages.json ***!
  \***************************************************/
/*! no static exports found */
/***/ (function(module, exports) {
...
/* 46 */
/*!************************************************************************!*\
  !*** D:/桌面/大三上所有课程作业/app开发作业/RiliQimo/components/ei-calendar/EDate.js ***!
  \************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
var EDate = /*#__PURE__*/function (_Date) {
  (0, _inherits2.default)(EDate, _Date);
  var _super = _createSuper(EDate);
  function EDate() {
    var _this;
    var params = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : [];
    var format = arguments.length > 1 ? arguments[1] : undefined;
    (0, _classCallCheck2.default)(this, EDate);
    // 只保留一个参数
    format && (format = replaceFormat(format));
    if (params.length > 1) {
      if (format) {
        _this = _super.call(this, Format((0, _construct2.default)(Date, (0, _toConsumableArray2.default)(params)), format));
      } else {
        _this = _super.call.apply(_super, [this].concat((0, _toConsumableArray2.default)(params)));
      }
  ...
  (0, _createClass2.default)(EDate, [{
    ...
    key: "modify",
    value: function modify(param) {
      return Modify(this, param);
    }
  }]);
  return EDate;
}( /*#__PURE__*/(0, _wrapNativeSuper2.default)(Date));
exports.default = EDate;
(0, _defineProperty2.default)(EDate, "format", Format);
(0, _defineProperty2.default)(EDate, "modify", Modify);
